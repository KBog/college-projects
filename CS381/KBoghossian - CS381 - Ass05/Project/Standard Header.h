...
{			
	...
	{
		Vertex Center;
		Center.x = (V0.x + V1.x)/2;
		Center.y = (V0.y + V1.y)/2;
...
{			
	...
	void Set_Properties (Collision_Type type, Vertex v0, Vertex v1, Vector normal)
	{
		Type=type;
		V0=v0;	V1=v1;
		Normal=normal;
...
{			
	...
	public:			
			...
			/* Function used for the behavior of the character */
			void (*pf) (Character *Object);
};
